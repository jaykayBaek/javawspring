...
insert into member values2 (default,'admin','1234','관리자','관리자',default,default,'010-3423-2704','경기도 안성시 공도로 142','cjsk1126@naver.com','http://cjsk1126.tistory.com','프리랜서','등산/바둑',default,'관리자입니다.',default,default,default,0,default,default,default,default);
