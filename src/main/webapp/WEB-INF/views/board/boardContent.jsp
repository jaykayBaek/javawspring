...
<head>
  ...
  <jsp:include page="/WEB-INF/views/include/bs4.jsp"/>
    ...
    */
    ...
    let updateReplyToggle = (idx) => {
    	$("#reply-demo"+idx).slideDown(200);
    }
    
    let updateReply = (idx) => {
    	let content = $("#update-content"+idx).val();
    	$.ajax({
    		type : "post",
    		url : "${ctp}/board/reply/"+idx,
    		data : {
	    ...
	    <tr>
	      ...
	      <td>
	        ${fn:replace(replyVo.content, newLine, "<br/>")}
  	      	<div id="reply-demo${replyVo.idx}" class="reply-demo">
				<textarea rows="4" name="updateContent" id="update-content${replyVo.idx}" class="form-control">${replyVo.content}</textarea>
				<button class="form-control" type="button" onclick="updateReply(${replyVo.idx})">수정</button>
	      	</div>
	      </td>
	      ...
	      <td class="text-center">
	      	...
	      	<button type="button" onclick="updateReplyToggle('${replyVo.idx}')">수정하기</button>
