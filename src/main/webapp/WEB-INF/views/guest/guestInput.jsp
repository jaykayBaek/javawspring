...
<div class="container">
  <form name="myform" method="post" class="was-validated">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="homePage" value="http://" id="homePage" placeholder="홈페이지 주소를 입력하세요." />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
	    ...
	    <button type="button" onclick="location.href='${ctp}/guest/list';" class="btn btn-primary">돌아가기</button>
    </div>
