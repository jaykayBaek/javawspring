...
public class ScheduleServiceImpl implements ScheduleService {
	...
	public void getCalendar() {
		...
		// sql에 등록되어 있는 dataformat에 맞춰 값을 입력해야함
		// 해당 년월의 형식 변환? 2023-1 -> 2023
		String ym = "";
		int intMM = mm + 1;
		...
		// 스케쥴에 등록되어 있는 일정들 가져오기
		List<ScheduleVO> vos = dao.getScheduleList(mid, ym);
	...
	public List<ScheduleVO> getScheduleMenu(String mid, String ymd) {
		...
		String mm, dd;
//		for(String tmp:ymds) {
//			if(Integer.valueOf(tmp)<=9 && Integer.valueOf(tmp)>=1) {
//			}
//		}
//		
		if(ymd.length() != 10) {
		...
		return dao.getScheduleMenu(mid, ymd);
	}
	...
	public void setScheduleUpdate(ScheduleVO vo) {
		dao.setScheduleUpdate(vo);
	}

	@Override
	public void setScheduleDelete(int idx) {
		dao.setScheduleDelete(idx);
	}
}
